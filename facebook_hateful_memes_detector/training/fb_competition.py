...
def train_and_predict(model_fn, datadict, batch_size, epochs, augmentation_weights: Dict[str, float],
                      multi_eval=False, scheduler_init_fn=None, class_weights={0: 1, 1: 1.8}):
    ...
    train_losses, learning_rates = train(model, optimizer, scheduler_init_fn, batch_size, epochs, dataset, plot=True, class_weights=class_weights)
