...
class TorchAmpTrainer(Trainer):
    def __init__(
        ...
        super().__init__(model, args, data_collator, train_dataset, eval_dataset, compute_metrics, prediction_loss_only, tb_writer, optimizers)
    ...
    def train(self, model_path: Optional[str] = None):
        ...
        if (
            ...
            and os.path.isfile(os.path.join(model_path, "scaler.pt"))
        ):
            ...
            scaler.load_state_dict(torch.load(os.path.join(model_path, "scaler.pt")))
